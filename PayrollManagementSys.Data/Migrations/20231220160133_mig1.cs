        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DepertmanId = table.Column<int>(type: "int", nullable: false),
                    Addres = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    StartedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    SGKNumara = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUsers_Departmans_DepertmanId",
                        column: x => x.DepertmanId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StartedDate_DayOff = table.Column<DateTime>(type: "datetime2", nullable: false),
                    EndedDate_DayOff = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SgkDeduction = table.Column<double>(type: "float", nullable: false),
                    AdditionalPayments = table.Column<double>(type: "float", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_DepertmanId",
                table: "AspNetUsers",
                column: "DepertmanId");
